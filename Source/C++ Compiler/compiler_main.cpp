...
//put them in the appropriate variables
{
    ...
    if(clArgList.size() != 5)
    {
        MessageBox(NULL, "Wrong number of compiler arguments", "Macrobyte Compiler", MB_OK | MB_ICONERROR | MB_SETFOREGROUND);
        ExitProcess(0);
    }
    ...
    {
	    MessageBox(NULL, (string("Runtime mode:\r\n\r\n'") + clArgList[0] + string("'\r\n\r\nis not understood")).c_str(),
    ...
    {
        MessageBox(NULL, (string("Woring directory:\r\n\r\n'") + clArgList[1] + string("'\r\n\r\ndoes not exist")).c_str(),
                   "Macrobyte Compiler", MB_OK | MB_ICONERROR | MB_SETFOREGROUND);
        ExitProcess(0);
    }
    ...
    {
        MessageBox(NULL, (string("Source code file:\r\n\r\n'") + clArgList[2] + string("'\r\n\r\ndoes not exist")).c_str(),
                   "Macrobyte Compiler", MB_OK | MB_ICONERROR | MB_SETFOREGROUND);
        ExitProcess(0);
    }
    ...
    {
        MessageBox(NULL, (string("Runtime executable file:\r\n\r\n'") + clArgList[3] + string("'\r\n\r\ndoes not exist")).c_str(),
                   "Macrobyte Compiler", MB_OK | MB_ICONERROR | MB_SETFOREGROUND);
        ExitProcess(0);
    }
...
//
{
    ...
    SetWindowText(hDispStatus, "Parsing source code...");
    CreateSubProgs();
    
    //Compile sub program definitions
    SendMessage(hDispProgress, PBM_SETPOS, 0, 0);
    SetWindowText(hDispStatus, "Compiling program definitions...");
    ...
    SendMessage(hDispProgress, PBM_SETPOS, 0, 0);
    SetWindowText(hDispStatus, "Compiling program code...");
    for(currDefIdx=0; currDefIdx < spDefList.size(); currDefIdx++)
    {
        currDefPtr = spDefList[currDefIdx];
        CompileSubProgCode();
    ...
    SetWindowText(hDispStatus, "Assembling program file...");
    AssembleFile();
