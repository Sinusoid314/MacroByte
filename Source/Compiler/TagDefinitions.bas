...
Public Const IDC_PrintToConsol = 31
Public Const IDC_InputFromConsol = 32
Public Const IDC_ShowConsol = 33
Public Const IDC_HideConsol = 34
Public Const IDC_PrintBlank = 35
Public Const IDC_FOR = 36
Public Const IDC_ClearConsol = 37
...
Public Const IDC_ConsolTitle = 72
